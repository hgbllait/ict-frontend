  ...
  parse(arr) {
    return arr.map(obj => {
      Object.keys(obj).forEach(key => {
        ...
        if(key === 'text') {
          let new_value = null;
          var value_split = obj[key].split(".");
          if(value_split && value_split[0] === 'ii_meta_materials'){
            let value_ = '';
            if(this.templateData.hasOwnProperty(value_split[0])){
              if(this.templateData[value_split[0]].hasOwnProperty(value_split[1])){
                if(this.templateData[value_split[0]][value_split[1]].hasOwnProperty(value_split[2])){
                  value_ = this.templateData[value_split[0]][value_split[1]][value_split[2]];
                }
              }
            }
            obj[key] = value_;
          ...
          if(new_value){
            if (this.templateData.hasOwnProperty(obj[key])) {
              ...
              if(new_value == 'meta_software'){
                obj[key] = this.addSpace(this.templateData[obj[key]], 14);
                return;
              }
              if(new_value == 'meta_others'){
                obj[key] = this.addSpace(this.templateData[obj[key]], 19);
                return;
              }
              if(new_value == 'meta_result'){
                let value_ = this.templateData[obj[key]];
                if(this.templateData[obj[key]] == "Others"){
                  if(this.templateData.hasOwnProperty('ii_meta_result_others')){
                    value_ = this.templateData['ii_meta_result_others'];
                  }
                }
                obj[key] = value_;
                return;
              ...
              if(new_value == 'date_effective'
                ...
                || new_value == 'meta_date_needed'
                || new_value == 'meta_repair_started_date'
                || new_value == 'meta_repair_ended_date'
              ...
              else if(new_value == 'meta_repair_started_time'
                || new_value == 'meta_repair_ended_time'){
                obj[key] = moment(this.templateData[obj[key]], "HH:mm").format('h:mm a');
              }
              else {
              ...
              || new_value == 'meta_certified_date_signed'
              || new_value == 'meta_approved_date_signed'){
                value_ = this.addSpace('', 20);
              }
              if(new_value == 'meta_software'){
                value_ = this.addSpace('', 25);
              }
              if(new_value == 'meta_others'){
                value_ = this.addSpace('_________________', 20);
              }
              obj[key] = value_;
            }
          }
        ...
        */
        if (key === 'textWrappingStyle') {
          ...
          // Checkbox
          if( obj['name'] == 'ii_meta_hardware_related'){
          ...
          for (const element of ['others', 'software',
            'System Unit', 'Switch/Routers/AP',
            'Monitor', 'CCTV',
            'Printer/Scanner', 'Projector',
            'UPS/AVR', 'Turnstile',
            'Bio-metric', 'SIP Phone']) {
            if( obj['name'] == 'checkbox_' + element){
              if(['others', 'software'].includes(element)) {
                if(this.templateData['ii_meta_'+element]) obj['imageString'] = "data:image/webp;base64,";
              } else {
                if(this.templateData['ii_meta_hardware']
                  && this.templateData['ii_meta_hardware'] == element) {
                  obj['imageString'] = "data:image/webp;base64,";
                }
